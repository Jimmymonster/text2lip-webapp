...
function Home() {
  return (
    <div>
      <Navbar />
      <div className="flex justify-center items-center w-full h-[calc(100vh-4rem)] min-h-fit">
        <div className="flex flex-col w-[80%] h-fit min-h-fit justify-center items-center bg-[color:var(--palette2)] rounded-xl px-4 py-4 gap-3" >
          <div className="flex flex-col w-full h-full min-h-fit bg-[color:var(--bg-box-col)] rounded-xl text-[color:var(--text-color-1)] font-inter font-semibold p-4">
