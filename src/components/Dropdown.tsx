    ...
    return (
      <div className="w-full">
        <select
          ...
          className="text-[color:var(--text-color-1)]  cursor-pointer bg-white hover:bg-slate-100 border border-slate-400 text-sm font-semibold rounded-xl block w-full p-2 "
        >
