    ...
    return (
      <div className="w-full h-full">
        <select
          ...
          className="text-[color:var(--text-color-1)]  cursor-pointer bg-[color:var(--bg-box-col)] hover:bg-[color:var(--bg-box-hover-col)] border-slate-400 text-sm font-semibold rounded-xl block w-full h-full p-2 "
        >
